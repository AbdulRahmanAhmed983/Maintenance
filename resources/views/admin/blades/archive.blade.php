                            ...
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="arab">اسم العميل</th>
                                        <th class="arab">رقم السيارة</th>
                                        <th class="arab">نوع السيارة</th>
                                        <th class="arab"> السيارة</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{++$id}}</td>
                                        <td>{{$item->main_no}}</td>
                                        <td class="arab">{{$item->clint_name}}</td>
                                        <td>{{$item->car_no}}</td>
                                        <td class="arab">{{$item->car_type}}</td>
                                        <td class="arab">{{$item->CarModel->name}}</td>
                                        <td>
                                            <form method="POST" action="/maintenance/home/{{$item->id}}" style="display: inline;">
                                                {{ method_field('DELETE') }}
                                                @csrf 
                                                <button onclick="return confirm('هل انت متاكد من عملية الحذف')" class="btn btn-danger bg-green-700 rounded-sm py-1 px-2 arab">حذف الصيانة</button>
                                            </form>
                                            <form method="POST" action="/maintenance/home/{{$item->id}}/restore" style="display: inline;">
                                                @csrf
                                                <button class="btn btn-success bg-green-700 rounded-sm py-1 px-2 arab">استرجاع</button>
                                            </form>
