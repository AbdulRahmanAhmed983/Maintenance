                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            {{-- #############################FORM DATA######################### --}}
                            <form  action="{{route('storeprocess')}}"method="POST"enctype="multipart/form-data">
                                @csrf
                                ...
                                <div id="store">
                                    ...
                                    <div class="form-row mb-4">
                                        <div class="form-group col-md-4">
                                        <select class="form-control arab" name="namePiece_id" id="close-num">
                                        ...
                                        {{-- <div class="form-group col-md-4">
                                            <input type="text" name="piece_no" class="form-control arab" placeholder="او رقم القطعة">
                                    ...
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="quantity" class="form-control arab">
                                ...
                                <div id="store2" style="display: none;">
                                    <div class="form-row mb-4">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="workship" class="form-control arab">
                                            @error("workship")<span class="text-danger"> {{$message}}</span> @enderror
                                        </div>

                                        <div class="form-group col-md-4">
                                            <label class="arab store-label "> الفئة</label>
                                            <input type="text" name="category" class="form-control arab">
