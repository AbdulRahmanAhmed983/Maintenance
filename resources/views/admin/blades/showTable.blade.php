                            ...
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="arab">{{$item->car_no}}</td>
                                        <td class="arab">{{$item->car_type}}</td>
                                        <td class="arab">{{$item->CarModel->name}}</td>
                                        <td>
                                            <a class="btn btn-success bg-green-700 rounded-sm py-1 px-2 arab" href="{{route('editmaintenance',$item->id)}}">تعديل</a>
                                            <a class="btn btn-warning bg-green-700 rounded-sm py-1 px-2 arab" href="{{route('archievedMain',$item->id)}}">غلق الصيانة</a>
